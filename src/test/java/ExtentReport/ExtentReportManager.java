...
public class ExtentReportManager {
    private static String reportDir=System.getProperty("user.dir")+"/Reports/playwrightReport.html";
    ...
    public static ExtentReports extentSetup(){
        ...
        extentSparkReporter.config().setReportName("PlayWright Ndosi Automation");
