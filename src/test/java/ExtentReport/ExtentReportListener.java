...
public class ExtentReportListener {
    private static String reportDir = System.getProperty("user.dir") + "/Reports/ndosiOnlineAutomationBootCamp.html";
    ...
    public static ExtentReports extentSetup() {
        ...
        extentSparkReporter.config().setReportName("ndosi OnlineAutomation BootCamp");
